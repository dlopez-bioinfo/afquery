...
| `db_version` | TEXT | DB version label at time of operation |
| `timestamp` | TEXT | ISO 8601 timestamp |
| `operation` | TEXT | `create`, `add`, `remove`, `compact`, `version_set` |
...
| v2 | + `fail_bitmap` | Added in Phase 12; requires `--include-all-filters` or default PASS-only |
