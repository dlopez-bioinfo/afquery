> **Note:** The HTTP API described in this document is not yet implemented. This is a design specification for a planned future feature. The current AFQuery release is a CLI/Python library only — no HTTP server is included.
